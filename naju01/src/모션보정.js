...
export const 기본보정 = {
  ...
  걷기팔붙임도: 8,
  // 위팔을 옆축 둘레로 돌린다(+ 뒤·아래로). 모든 동작에 건다 — 팔짱 대기처럼 클립별 값으로 쓴다.
  팔내림도: 0,
  // 아래팔을 옆축 둘레로 돌린다(+ 펴는 쪽). 클립별 값으로 쓴다.
  아래팔돌림도: 0,
...
const 자세보정 = (값) => [
  ...
  ["upperarm_l", 옆축, 값.팔내림도, false],
  ["upperarm_r", 옆축, 값.팔내림도, false],
  ["lowerarm_l", 옆축, 값.아래팔돌림도, false],
  ["lowerarm_r", 옆축, 값.아래팔돌림도, false],
