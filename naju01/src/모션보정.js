...
export const 기본보정 = {
  ...
  // 골반을 앞으로 기울이면 엉덩이가 뒤로 빠진다. 그만큼 상체가 같이 숙여지므로
  // 허리를 더 세워 가슴은 세운 채 엉덩이만 빠지게 만든다.
  골반기울기도: 10, // + 면 엉덩이가 뒤로
  // 요추(spine_01)만 골반과 **반대로** 돌리면 엉덩이~허리 사이가 오목해진다.
  // 원본 캐릭터에는 있는 굴곡인데 새 몸체는 등이 평평해서 이걸로 만들어 준다.
  허리곡선도: 12,
