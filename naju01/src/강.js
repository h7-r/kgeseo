...
// ★ 자리를 **택촌보다 뒤로** 잡아야 한다.
//   예전에는 물가(강.Z시작+건너)에 세웠는데, 높이가 17.3 m 라 4~6 m 짜리
//   초가집을 통째로 가렸다(「택촌 앞에 흰 가림막」 신고). 지금 씬은
//   `강.Z시작 + 건너 + 60` 에 세운다 — 택촌(z 87~118) 뒤 16 m 다.
//   `겹수` 는 겹마다 30 m 씩 더 뒤로 물러나며 지평색으로 옅어진다.
