...
export default function 앙암바위({ 누름 = () => {} }) {
  return (
    <>
      {/* 왼쪽 — 링 세 겹 72:1022 */}
      <div style={{ ...놓기(132, 6143, 820), display: "flex", flexDirection: "column", alignItems: "center" }} data-node-id="72:1022">
        <div style={바깥링}>
          <div style={안쪽링}>
            <div style={사진틀}>
      ...
      {/* 오른쪽 — 설명 72:1034 */}
      <div style={{ ...놓기(1012, 6213, 720), display: "flex", flexDirection: "column", gap: "40px" }} data-node-id="72:1034">
