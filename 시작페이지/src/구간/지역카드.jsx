...
const 카드 = [
  { 칸: 놓기(188, 5309, 500, 468), 사진: 에셋.imgBg, 이름: "버려진 연구소", 별: "★★★☆☆",
    설명: "폐쇄된 지하 연구시설. 실험 기록 속 숨겨진 진실을 밝혀라.", id: "48:1520" },
  { 칸: 놓기(703, 5351, 500, 468), 사진: 에셋.imgBg2, 이름: "고대 도서관", 별: "★★★★☆",
    설명: "수백 년 된 비밀 서재. 고서 속 암호가 탈출의 열쇠다.", id: "48:1528" },
  { 칸: 놓기(1218, 5309, 500, 468), 사진: 에셋.imgBg1, 이름: "시계탑의 비밀", 별: "★★★★★",
...
export default function 지역카드() {
  return (
    <>
      {카드.map(({ 칸, 사진, 이름, 별, 설명, id }) => (
        <div key={id} className="카드" style={{ ...칸, ...카드틀 }} data-node-id={id}>
          {/* 사진 + 어둡게 깔아 주는 막 */}
      ...
      <div style={{ ...놓기(108, 5495), ...화살표, ...막음 }} title={막음안내} data-node-id="129:1257">‹</div>
