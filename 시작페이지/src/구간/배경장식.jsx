...
export default function 배경장식() {
  return (
    <>
      {/* 121:2554 · 121:2377 — 겹겹의 큰 원.
          원본은 1.4MB·1.1MB 짜리 SVG 두 장이었는데, 선 세 개를 그리는 데
          2.5MB 를 쓸 이유가 없어 CSS 로 다시 그렸다. 자세한 이유는 겹원.jsx. */}
      <겹원 칸={놓기(606, 3949, 960, 960)} 무늬="가" 이름="121:2554" />
      <겹원 칸={놓기(472, 5967, 960, 960)} 무늬="나" 이름="121:2377" />
