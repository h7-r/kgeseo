...
// (모션보정.js 의 보폭배율), 1.45m 기준 클립의 고유 속도는
// Walk_Loop 0.57 m/s, Jog_Fwd_Loop 1.58 m/s, Sprint_Loop 2.21 m/s다.
//   걷기 1.03 m/s(3.44유닛) → Walk_Loop 1.81배. 원본 클립이 느긋한 산책이라
//   이 정도 배속이 보통 걸음의 보속이 된다.
//   달리기 2.48 m/s(8.26유닛) → Sprint_Loop 1.12배.
const WALK = 3.44,
  RUN = 2.4,
  CROUCH = 0.55;
const GRAVITY = -30,
